...
При запросе только на ревью не редактируй тесты или конфигурацию. В результате укажи, какое поведение проверено, какие команды выполнены и что осталось непроверенным. Соблюдай инструкции целевого проекта; AGENTS.md из этого набора не обязателен.
