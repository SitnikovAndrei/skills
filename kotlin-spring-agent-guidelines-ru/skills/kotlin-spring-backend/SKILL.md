...
3. Внеси минимальное изменение и проверь relevant web slice или integration test, если корректность зависит от Spring. Для простого внутреннего изменения достаточно проверки его поведения.
